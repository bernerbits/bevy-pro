...
public class BeverageDaoImpl implements BeverageDao {
	...
	public List<Beverage> getBeverages() {
		...
		bevs.add(new Beverage("1","images/cocacola.gif","Coca-Cola",65,0,false));
		bevs.add(new Beverage("2","images/dietcoke.png","Diet Coke",65,1,false));
		bevs.add(new Beverage("3","images/sprite.jpg","Sprite",65,2,false));
		bevs.add(new Beverage("4","images/mtndew.jpg","Mountain Dew",65,3,false));
		return bevs;
	}
